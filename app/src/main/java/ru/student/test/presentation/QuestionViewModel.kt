...
import ru.student.test.data.QuestionRepositoryImpl
import ru.student.test.domain.entity.GameResult
...
import ru.student.test.domain.usecases.GetGameSettingsUseCase
import ru.student.test.domain.usecases.GetQuestionsUseCase
